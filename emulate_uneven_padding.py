'''
Split a file while emulating uneven padding. Assuming starting point of each gesture is known.
'''
...
def split(working_dir, num_frames_per_gesture):
    ...
    for a in annot[:]:
        ...
        starting_frame[a] = len(frame_indices)
    ...
    for a in annot[:]:
        ...
        start = starting_frame[a]
        end = int(start + fps * duration)
